...
__DEFINE__(1648981510650, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1648981510651,"./event-store":1648981510652}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1648981510651, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1648981510652, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1648981510651,"./utils":1648981510653}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1648981510653, function(require, module, exports) {
...
return __REQUIRE__(1648981510650);
})()
