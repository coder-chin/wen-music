...
__DEFINE__(1649588495810, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1649588495811,"./event-store":1649588495812}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1649588495811, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1649588495812, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1649588495811,"./utils":1649588495813}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1649588495813, function(require, module, exports) {
...
return __REQUIRE__(1649588495810);
})()
